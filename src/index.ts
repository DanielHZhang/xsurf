...
export function urlSafeBase64(rawBase64: string) {
 ...
 */
export function createChecksum(token: string, secret: string) {
 ...
 * @param secret Shared secret key.
 */
export function verifyChecksum(token: string, checksum: string, secret: string) {
